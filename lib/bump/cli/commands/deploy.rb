  ...
  class CLI
    module Commands
      class Deploy < Base
        ...
        option :documentation, default: ENV.fetch("BUMP_ID", ""), desc: "Documentation id or slug"
        option :'documentation-name', desc: "Documentation name. Used with --auto-create flag."
